...
class login_signup_form extends moodleform implements renderable, templatable {
    function definition() {
        ...
        // ------------------- ADDED HIDDEN INPUTS ------------------- //
        // Add hidden input for 'callback' parameter
        $callback = optional_param('callback', '', PARAM_ALPHANUMEXT);
        $mform->addElement('hidden', 'callback', $callback);
        $mform->setType('callback', PARAM_ALPHANUMEXT);

        // Add hidden input for 'gid' parameter
