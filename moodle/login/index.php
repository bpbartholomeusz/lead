...
if (isloggedin() and !isguestuser()) {
  ...
  // // Check if the user is already on the "My Courses" page
  // $currenturl = new moodle_url($FULLME);
  // if ($currenturl->compare(new moodle_url('/my/courses.php')) !== 0) {
  //   // Redirect to "My Courses" page only if they are not already there
  //   redirect($CFG->wwwroot . '/my/courses.php');
  // }
}
