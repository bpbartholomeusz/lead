...
$sinfo = (!empty(theme_klass_get_setting('infotitle'))) ? theme_klass_get_setting('infotitle') : get_string('info', 'theme_klass');
$scontactus = (!empty(theme_klass_get_setting('contacttitle'))) ? theme_klass_get_setting('contacttitle') : get_string('contact_us', 'theme_klass');
$sgetsocial = (!empty(theme_klass_get_setting('socialtitle'))) ? theme_klass_get_setting('socialtitle') : get_string('get_social', 'theme_klass');
