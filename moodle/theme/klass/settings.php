...
if (is_siteadmin()) {
    ...
    // Info block Title.
    $name = 'theme_klass/infotitle';
    $title = get_string('infotitle', 'theme_klass');
    $description = '';
    $default = get_string('infotitle_default', 'theme_klass');
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $temp->add($setting);
    ...
    // Contact block Title.
    $name = 'theme_klass/contacttitle';
    $title = get_string('contacttitle', 'theme_klass');
    $description = '';
    $default = get_string('contacttitle_default', 'theme_klass');
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $temp->add($setting);
    ...
    // Social block Title.
    $name = 'theme_klass/socialtitle';
    $title = get_string('socialtitle', 'theme_klass');
    $description = '';
    $default = get_string('socialtitle_default', 'theme_klass');
    $setting = new admin_setting_configtext($name, $title, $description, $default);
    $temp->add($setting);
