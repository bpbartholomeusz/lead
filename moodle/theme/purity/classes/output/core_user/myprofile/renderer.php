...
class renderer extends \plugin_renderer_base {
    ...
    public function render_category(category $category) {
        ...
        $return = '';
        if (empty($classes)) {
            $return .= \html_writer::start_tag('div', array('class' => 'node_category card d-inline-block w-100'));
        } else {
            $return .= \html_writer::start_tag('div', array('class' => 'node_category card d-inline-block w-100' . $classes));
        }
        $return .= \html_writer::start_tag('div', array('class' => 'card-header'));
        $return .= \html_writer::tag('h3', $category->title, array('class' => 'card-title mb-0'));
        $return .= \html_writer::end_tag('div');
