...
require('../config.php');
require_once($CFG->dirroot . '/enrol/custom/utils.php'); // Include the utils.php file
...
$stage_category_id = get_course_stage_category($id);

// foreach ($forms as $form) {
//   echo $form; // Show enrollment form if prerequisites are met
// }

// Check if user has met the prerequisites for the stage
if (has_met_stage_prerequisites($USER->id, $stage_category_id)) {
  foreach ($forms as $form) {
    echo $form; // Show enrollment form if prerequisites are met
  }
} else {
